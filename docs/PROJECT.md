...
5. Alert 수동 해제(단건/Bulk) 시 Slack "[Manually Resolved]" 알림 + Agent 분석(단건만)
6. 운영자가 Feedback(투표/코멘트)와 Chat, Webhook Settings로 운영 품질 개선
7. SSE + polling fallback으로 UI 상태를 실시간 동기화
