...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.BulkResolveAlertsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.BulkResolveAlertsResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.AlertResolveResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.WebhookConfigListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.WebhookConfigRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.WebhookConfigMutationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.WebhookConfigResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "model.BulkResolveAlertsRequest": {
            "type": "object",
            "required": [
                "alert_ids"
            ],
        ...
        "model.BulkResolveAlertsResponse": {
            "type": "object",
            "properties": {
                "failed": {
                    "type": "integer"
        ...
        "model.WebhookConfigListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "model.WebhookConfigMutationResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
